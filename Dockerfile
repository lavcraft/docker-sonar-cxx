...
COPY ./sonar-cxx-plugin-0.9.3.jar $SONARQUBE_HOME/extensions/plugins/sonar-cxx-plugin-0.9.3.jar
COPY ./sslr-cxx-toolkit-0.9.3.jar $SONARQUBE_HOME/extensions/plugins/sslr-cxx-toolkit-0.9.3.jar
